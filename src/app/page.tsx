...
const COPY = {
  ar: {
    ...
    h1a: 'ابنِ متجرك وأطلق إعلاناتك',
    h1grad: 'بالذكاء الاصطناعي',
    h1b: 'في 60 ثانية',
    sub: 'الذكاء الاصطناعي يكتب صفحة منتجك احترافياً، يجهّز الدفع عند الاستلام، ويربطك بإعلانات تيك توك ومتا وجوجل وسناب — كله من لوحة واحدة.',
    ...
    spots: [
      {
        ...
        bullets: ['قالب عربي كامل — يعمل على الموبايل بشكل مثالي', 'صفحة بيع احترافية لكل منتج بالذكاء الاصطناعي', '100 طلب مجاني لكل متجر جديد — بدون بطاقة'],
      },
      {
        tag: 'هجرة المتجر', icon: 'Refresh', accent: '#7c5cff',
        title: 'انقل كل منتجاتك وسجل طلباتك بنقرة واحدة',
        desc: 'هجرة من أي منصة عبر رابط URL أو API Key أو تحميل JSON — الصور والأسعار والطلبات تنتقل كاملة.',
        bullets: ['الصق رابط متجرك ونجلب كل منتجاتك تلقائياً', 'سجل طلباتك القديمة محفوظ بالكامل تلقائياً', 'راجع منتجاتك قبل تأكيد الاستيراد'],
      },
      {
        tag: 'إعلانات تيك توك', icon: 'Megaphone', accent: '#06b6d4',
        title: 'أنشئ وتابع حملاتك — فردية أو جماعية — في دقيقتين',
        desc: 'اربط حساب الأعمال، أطلق الحملات، عدّل الميزانيات، وتابع عائدك — كله من لوحة واحدة.',
        bullets: ['إطلاق حملات فردية أو جماعية بنقرة واحدة', 'متابعة الإنفاق والعائد والـ CTR لحظة بلحظة', 'كشف Smart+ وإجراءات جماعية سريعة'],
      },
      {
        tag: 'الإعلانات الرابحة', icon: 'Video', accent: '#f59e0b',
        title: 'اكتشف الفيديوهات الرابحة قبل منافسيك',
        desc: 'ابحث في TikTok وYouTube Shorts عن أكثر الفيديوهات نجاحاً — وحوّلها لإلهام إعلاناتك.',
        bullets: ['بحث بالكلمة المفتاحية عبر تيك توك ويوتيوب', 'عرض المشاهدات والتفاعلات بشكل مقارن', 'اربط الفيديو بمنتجك مباشرة'],
      },
    ],
    ...
    steps: [
      ...
      { t: 'الذكاء الاصطناعي يصمّم', d: 'عنوان، وصف، مميزات، وصور — بالعربي وجاهزة للبيع.' },
      { t: 'انشر وابدأ البيع', d: 'رابط جاهز للإعلانات — الطلبات تصل مباشرة للوحة التحكم.' },
    ],
    ...
    tests: [
      { q: 'أطلقت أول حملة في نفس اليوم. الصفحة العربية كانت أنظف مما كنت أصنعه يدوياً.', n: 'أحمد م.', r: 'تاجر إلكترونيات — القاهرة' },
      { q: 'الدفع عند الاستلام وإدارة الطلبات في مكان واحد وفّرت عليّ الكثير من الأدوات.', n: 'سارة ك.', r: 'متجر إكسسوارات — الرياض' },
      { q: 'ربط تيك توك مباشرة بالمتجر غيّر طريقة عملي بالكامل.', n: 'يوسف ب.', r: 'دروبشيبينج — الدار البيضاء' },
    ],
    pricingTitle: 'ابدأ مجاناً. ادفع حسب نموّك.',
    pricingSub: 'بدون رسوم شهرية. بدون مفاجآت.',
    plans: [
      { name: 'المجاني', price: '0', unit: 'جنيه', tag: 'للبداية', feats: ['100 طلب مجاني', 'صفحات منتج بالذكاء الاصطناعي', 'الدفع عند الاستلام', 'لوحة تحكم كاملة', 'جميع البكسلات'], cta: 'ابدأ مجاناً', highlight: false },
    ...
    finalTitle: 'متجرك يبدأ برابط واحد',
